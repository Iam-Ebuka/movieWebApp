 ...
 const likeBotton = () => {
  ...
  return (
    ...
    <p  id='like' onClick={likeBotton}>
      ...
      <i style={{fontSize: "30px", color: '#be123c', zIndex: '3', fontWeight: 'bolder', cursor: 'pointer' }} class="fa fa-heart" ></i>
       : 
       // Render the outline heart icon when not liked
       <i style={{fontSize: "30px", color: '#be123c', zIndex: '3', fontWeight: 'bolder', cursor: 'pointer' }} class="fa fa-heart-o" ></i>
        }
    </p>
